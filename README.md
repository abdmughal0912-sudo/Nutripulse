...
<h1 align="center">NutriPulse AI v4.6.0</h1>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Release-v4.6.0-6A5ACD" alt="Release v4.6.0">
...
<p align="center">
  ...
  <a href="https://github.com/abdmughal0912-sudo/Nutripulse/archive/refs/heads/main.zip">
    <img src="https://img.shields.io/badge/Download-NutriPulse_v4.6.0-2EA44F?style=for-the-badge&logo=github&logoColor=white" alt="Download NutriPulse v4.6.0">
  </a>
...
NutriPulse is a nutrition intelligence platform built with Streamlit, FastAPI, persistent PostgreSQL or local SQLite, Pandas, Plotly, ONNX/OpenCV inference, bundled RapidOCR, and a portable pure-Python food-quality classifier. Version 4.6.0 introduces a luxury animated public landing page and responsive dark split-screen authentication while preserving reboot-safe cloud accounts, Gmail verification, automatic day/week progression, analytics and separated Customer, Dietitian and Administrator workspaces. Aggregate lineage in the public repository audits all 76,920 supplied source rows without publishing person-level benchmark rows.
...
**[Download NutriPulse AI v4.6.0](https://github.com/abdmughal0912-sudo/Nutripulse/archive/refs/heads/main.zip)**
